...
class Decoder(nn.Module):
    def __init__(self, embedding_dim, channels,bottleneck_dim,image_latent_dim,neural_latent_dim,neural_dim,image_private_dim,neural_private_dim,pose_dim):
        ...
        self.imagedense=nn.Linear(bottleneck_dim*2,image_latent_dim)
        self.neuraldense=nn.Linear(bottleneck_dim*2,neural_latent_dim)
    ...
    def forward(self, x,y):
        ...
        image_latent=self.imagedense(global_latent)
        
        neural_latent=self.neuraldense(global_latent)
        ...
        return global_latent,image_latent,neural_latent,image_pred,neural_pred,image_previate,neural_previate
